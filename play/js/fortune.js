...
(function () {
  ...
  var TXT = {
    ...
    // 고블럽이 나쁜 시험 기운을 씹어먹은 뒤 보여줄 반전 운세(같은 인덱스 짝)
    studyFix: [
      "방해 기운은 고블럽이 꿀꺽! 친구와 페이스만 맞추면 오늘 계획은 무조건 끝납니다. 시작이 반이에요!",
      "집중력 도둑을 고블럽이 통째로 삼켰어요! 이제 폰만 뒤집어 두면 무적 모드. 50분 몰입도 거뜬합니다.",
      "고블럽이 기운을 한 번 더 데워줬어요! 이해가 두 배로 빨라지는 흐름 — 지금 바로 책상에 앉으면 최고 효율.",
      "들썩이던 엉덩이 기운을 고블럽이 냠냠! 번뜩이는 아이디어만 남았으니 노트 정리 시작하면 술술 풀려요.",
      "딴짓 유혹을 고블럽이 모조리 먹어치웠어요! 첫 25분만 버티면 오늘은 몰입 천재가 됩니다. 방 청소는 내일!",
      "고블럽이 기운을 반짝반짝 닦아줬어요! 복습 한 바퀴가 시험장에서 두 배로 돌아오는 날입니다.",
      "시험 압박을 고블럽이 으적으적! 부담이 사라진 자리에 마감 파워만 남았어요. 오늘 진도, 생각보다 잘 나갑니다.",
      "고블럽이 흐트러진 기운을 줄 세웠어요! 시간표대로만 가면 오늘은 계획 달성 100%.",
      "고블럽 부스터 발동! 직감이 더 예리해졌어요. 제일 어려운 문제부터 잡아도 풀리는 날입니다.",
      "고블럽이 배움의 기운을 두 배로 불렸어요! 오늘 외운 건 시험날까지 안 잊어버립니다."
    ],
    month: [
  ...
  function get(data, birth, now) {
    ...
    return {
      ...
      study: { score: clamp(SCORE.study[ssDay] + mod), text: TXT.study[ssDay], fix: TXT.studyFix[ssDay] },
