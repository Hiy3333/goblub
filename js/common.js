...
(function () {
  ...
  var logoHTML = isHome
    ? '<img class="logo-img" src="' + root + '/img/logo.png?v=4" alt="goblub" />'
    : // 서브 페이지 HOME — GOBLUB 로고와 같은 서체·크기, O는 로고의 고브럽 머리 그대로
      '<img class="logo-img" src="' + root + '/img/home.png?v=11" alt="Home" />';
  var headerHTML =
...
(function () {
  ...
  document.write('<script src="' + root + '/js/i18n.js?v=2"><\/script>');
  document.write('<script src="' + root + '/js/i18n-more.js?v=3"><\/script>');
})();
