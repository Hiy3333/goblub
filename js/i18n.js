...
(function () {
  ...
  S("닉네임·펫·가게 이름·태명 — AI가 센스있게 뚝딱", "Nicknames, pets, shops — AI names them with style", "Apodos, mascotas, tiendas — la IA los nombra con estilo", "Nickname, peliharaan, toko — AI menamai dengan gaya", "ニックネーム・ペット・お店 — AIがセンス良くパパッと", "ชื่อเล่น สัตว์เลี้ยง ร้านค้า — AI ตั้งให้แบบมีเซนส์", "昵称·宠物·店名 — AI妙笔起名", "暱稱·寵物·店名 — AI妙筆起名");
