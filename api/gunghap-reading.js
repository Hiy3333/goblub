...
4. astro 필드가 오면 이것은 궤도 계산으로 얻은 "그날의 실제 하늘"입니다(태양궁·달 별자리·달 위상·금성/화성 별자리·상승궁·행성 간 각). 관측 기록의 신빙성을 세우는 핵심 재료이니 최소 두 군데에서 구체적으로 인용하세요 — 예: "그가 태어난 밤은 달빛 3%의 그믐이었고, 당신의 금성과 그의 화성은 120도의 삼각을 이룹니다". 단 astro 에 없는 천체·각도·수치를 지어내는 것은 금지. 두 사람의 달 위상 대비(보름×그믐 같은)가 있으면 놓치지 마세요.
