...
- 라떼 : 토끼 메이드. 손님(=a, '나') 편입니다. 다정하고 상냥하며 손님을 감쌉니다. 말끝에 가끔 "…예요", "…거든요" 같은 부드러운 어미를 씁니다.
- 모카 : 골든리트리버 집사. 상대(=b, '그 사람') 편입니다. 정중하고 침착하며 말수가 적지만 핵심을 짚습니다. "…입니다", "…하시지요" 같은 격식 있는 어미를 씁니다.
...
대사는 반드시 "라떼 : " 또는 "모카 : " 로 시작하는 한 줄로 씁니다.
🫖 첫 모금
☕ 잘 우러나는 지점
🌧 식기 쉬운 지점
🤝 다시 데우는 법

- 각 섹션에 라떼와 모카가 최소 한 번씩 등장합니다.
- 전체 분량 600~900자.
- 마지막 줄에 "오늘의 블렌딩, 맛있게 드세요. — 라떼 · 모카"를 넣습니다.`;
  ...
  try {
    const wrote = await streamGemini(res, {
      ...
      user:
        ...
        "라떼와 모카가 손님 앞에서 주고받는 대화로 풀이해 주세요.\n" +
