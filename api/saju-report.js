...
◆ 실을 지키는 법 — yongshin 데이터를 근거로 "▸ 색 · / ▸ 방향 · / ▸ 공간 · / ▸ 행동 ·" 4줄 처방 + 각각 일상 적용법. 기신 발동 최악 패턴 1개 경고 + ◈ 낙인.`,
...
◆ 먹물을 바꾸는 법 — yongshin 데이터를 근거로 "▸ 색 · / ▸ 방향 · / ▸ 공간 · / ▸ 습관 ·" 4줄 + 각각 일상 적용법. 기신 발동 최악 생활 패턴 1개 경고.
◆ 귀곡이 붓을 놓으며 — 올해~2년 안 실행할 것 2~3가지를 문단으로 당부하고, 마지막은 이 톤으로 매듭: "명부는 먹으로 적지만, 마지막 획은 늘 산 자가 긋는다." + "사주는 재미로, 인생은 네 선택으로." 한 줄 + ◈ 낙인(리포트 전체를 압축한 인장명).`,
