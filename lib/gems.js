// 유료 젬리 서버 원장 — 잔액의 진실은 서버(KV)에만 있다.
//
// 놀이 젬리(feed.js, localStorage 적립)와 완전히 분리된 별도 재화다.
...
//   sales:gems:{content}  콘텐츠별 누적 사용 젬리
//   sales:day:{yyyymmdd}  일자별 사용 젬리 (40일 보관 — 추후 그래프용)
//   pev                   유료 젬리 감사 로그 (최근 1000건)
